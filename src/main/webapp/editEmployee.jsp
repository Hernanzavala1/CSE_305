...
<br>
	...
	<form action="updateEmployee" method="POST">
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" id="SSN" name="SSN" placeholder="XXX-XX-XXXX" value=${editEmployee.SSN} readonly>
	  </div>
   	  <div class="form-group">
	   ...
	   <div class="form-group">
	    ...
	    <input type="checkbox" class="form-control" id="isManager" name="isManager" placeholder="Is Manager" ${editEmployee.isManager == true ?'checked' : ''}>
	  </div> 
